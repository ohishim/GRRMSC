...
When you set `MSC="GCp"` and `alpha="optimized"`, a value of $\alpha$ in generalized $C_p$ criterion is optimized by a method proposed by Ohishi, Yanagihara & Wakaki (2020, KES-IDT-20; [10.1007/978-981-15-5925-9_23](https://doi.org/10.1007/978-981-15-5925-9_23)).
...
This package also has a function `pGRR.MSC` which performs for partial generalized ridge regression.
